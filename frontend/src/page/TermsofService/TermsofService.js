  ...
  return (
    <div style={{ paddingTop: "150px" }}>
      ...
      <p style={{ paddingLeft: "15px" }}>
        ...
        on Fern.fun's Website for personal, non-commercial transitory viewing
      ...
      <p style={{ paddingLeft: "15px" }}>
        ...
        Fern.fun may change the materials contained on its Website at any time
        without notice. Fern.fun does not make any commitment to update the
        materials.
      </p>
      ...
      <p style={{ paddingLeft: "15px" }}>
        Fern.fun has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by Fern.fun of the site. The use
        of any linked website is at the user’s own risk.
      </p>

      <h2>
        <span className="c-secondary">7.</span> Site Terms of Use Modifications
      </h2>
      ...
      <p style={{ paddingLeft: "15px" }}>
        Any claim related to Fern.Fun's Website shall be governed by the laws of
